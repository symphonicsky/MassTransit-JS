...
export type MessageHandler<T extends MessageMap> = (
  message: ConsumeContext<T>
) => void;
...
export interface MessageTypeDeserializer<T extends MessageMap>
...
export class MessageTypeDeserializer<T extends MessageMap>
  implements MessageTypeDeserializer<T>
{
